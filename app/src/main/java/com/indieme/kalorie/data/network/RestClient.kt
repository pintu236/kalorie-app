...
import com.indieme.kalorie.utils.K_BEARER
...
object RestClient {
    ...
    init {
        cache = Cache(KalorieApplication.mApplicationContext!!.cacheDir, SIZE_OF_CACHE)
        initHttpClient()
        initGson()
        initRetrofit()
    }
    ...
    private fun hasNetwork(): Boolean {
        return try {
            val connectivityManager =
                KalorieApplication.mApplicationContext!!.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
